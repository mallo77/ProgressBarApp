var ProgressBarDemo = React.createClass({
	...
	render: function () {
		...
		return (
			<section className="progress-bar-demo">
	  			<div className="row">
		    		<div className="small-11 medium-11 large-10 columns small-centered">
		      			<h2>Progress Bars Demo</h2>		        	

						<ProgressBarGroup bars={this.barOptions()} />
		        					
				        <div className="row panel">
			        	  	<Selector onSelectChange={this.handleSelectChanged} />
				         	
				         	<div className="large-7 medium-7 small-12 columns">
				         		<ButtonGroup onButtonClick={this.handleButtonClicked} 
